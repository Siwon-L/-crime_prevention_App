     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         databaseReference.addValueEventListener(new ValueEventListener() {
             ...
             public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                 ...
                 if(openonoff==1) {
                     if (openS == 1) {
                         opentext.setText("감지 됨");
                         openL.setBackgroundResource(R.drawable.detected);
                         if (openC == 1) {

                             serviceIntent.putExtra("sensor", 1);

                             openC = 0;
                         }
                     } else {
                         opentext.setText("감지되지 않음");
                         openL.setBackgroundResource(R.drawable.not_detected);
                         openC = 1;

                     }
                 }
                 else{
                     opentext.setText("센서 꺼짐");
                     openL.setBackgroundResource(R.drawable.not_detected);
                 ...
                 if(humanonoff==1) {
                     if (humanS == 1) {
                         humantext.setText("감지 됨");
                         humanL.setBackgroundResource(R.drawable.detected);
                         if (humanC == 1) {

                             serviceIntent.putExtra("sensor", 2);

                             humanC = 0;
                         }
                     } else {
                         humantext.setText("감지되지 않음");
                         humanL.setBackgroundResource(R.drawable.not_detected);
                         humanC = 1;
                     }
                 }
                 else{
                     humantext.setText("센서 꺼짐");
                     humanL.setBackgroundResource(R.drawable.not_detected);
                 }
                 //----------------------------------------------
                 ...
                 if(flameonoff==1) {
                     if (flameS == 1) {
                         flametext.setText("감지 됨");
                         flameL.setBackgroundResource(R.drawable.detected);
                         if (flameC == 1) {

                             serviceIntent.putExtra("sensor", 3);

                             flameC = 0;
                         }
                     } else {
                         flametext.setText("감지되지 않음");
                         flameL.setBackgroundResource(R.drawable.not_detected);
                         flameC = 1;
                     }
                 }
                 else{
                     flametext.setText("센서 꺼짐");
                     flameL.setBackgroundResource(R.drawable.not_detected);
