...
public class MainActivity extends AppCompatActivity {
    ...
    private int nf, start, Bsave;
    private ImageView image;
    private String cctvip;
    private LinearLayout humanL, flameL, openL;
    private SharedPreferences pref, btnsave;
    private SharedPreferences.Editor editor, btn_save_editor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor = pref.edit();
        btnsave = getSharedPreferences("btnsave", Activity.MODE_PRIVATE);//특정 상황에만 포그라운드를 실행할 수 있게 쉐어드프리퍼런스 사용.
        btn_save_editor = btnsave.edit();
        ...
        btnon.setOnClickListener(new View.OnClickListener() {//Off버튼
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                btn_save_editor.putInt("Bsave", 0);
                btn_save_editor.apply();
        ...
        btnoff.setOnClickListener(new View.OnClickListener() {//on버튼
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                btn_save_editor.putInt("Bsave", 1);
                btn_save_editor.apply();
